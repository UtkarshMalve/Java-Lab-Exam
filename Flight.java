...
public class Flight {
	...
	public Flight(int flighId, String destination, double ticketPrice, int seatsAvailable, String departureTime) throws seatsAvailableException{
		if(seatsAvailable<=0)
		{
	...
	public String toString() {
		return "Flight [flighId=" + flighId + ", destination=" + destination + ", ticketPrice=" + ticketPrice
